...
import com.shanai.base.app.ApplicationLifecycle
import com.shanai.base.BaseApplication
import com.shanai.base.constant.VersionStatus
import com.shanai.base.utils.ForegroundBackgroundObserver
import com.shanai.base.utils.ProcessUtils
import com.shanai.base.utils.SpUtils
import com.shanai.base.utils.network.NetworkStateClient
...
class CommonApplication : ApplicationLifecycle, ForegroundBackgroundObserver {
     ...
     * 腾讯 MMKV 初始化
     */
    private fun initxLog(): String {
        val result = XLog.init(LogLevel.ALL);
        return "XLog -->> init complete"
    }
    ...
    private fun initTencentBugly(): String {
        ...
        CrashReport.initCrashReport(
            BaseApplication.context, BaseApplication.context.getString(R.string.BUGLY_APP_ID), BuildConfig.VERSION_TYPE != VersionStatus.RELEASE
        )
