package com.shanai.shanai.common.view.loadingdrawable.render.shapechange;
...
public class CircleBroodLoadingRenderer extends LoadingRenderer {
    ...
    private final int DEFAULT_OVAL_COLOR = Color.parseColor("#fcea64");
    ...
    private final int DEFAULT_BACKGROUND_DEEP_COLOR = Color.parseColor("#00ffffff");
