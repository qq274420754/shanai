package com.shanai.shanai.common.view.loadingdrawable.render.scenery;
...
import com.shanai.shanai.common.view.loadingdrawable.DensityUtil;
import com.shanai.shanai.common.view.loadingdrawable.render.LoadingRenderer;
...
public class ElectricFanLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mLeafDrawable = context.getResources().getDrawable(R.drawable.common_ic_leaf);
        mLoadingDrawable = context.getResources().getDrawable(R.drawable.common_ic_loading);
        mElectricFanDrawable = context.getResources().getDrawable(R.drawable.common_ic_eletric_fan);
