...
import com.mm.shanai.common.adapter.CustomSpacingItemDecoration
import com.mm.shanai.common.view.magicindicator.ScaleTransitionPagerBoldTitleView
import com.mm.shanai.common.view.magicindicator.ViewPagerHelper
import com.mm.shanai.common.view.magicindicator.buildins.UIUtil
import com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.CommonNavigator
import com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.abs.CommonNavigatorAdapter
import com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.abs.IPagerIndicator
import com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.abs.IPagerTitleView
import com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.indicators.LinePagerIndicator
import com.mm.shanai.module.home.adapter.FriendTopBannerAdapter
import com.mm.shanai.module.home.adapter.FriendTopMenuAdapter
import com.mm.shanai.module.home.adapter.ScrollViewModel
import com.mm.shanai.module.home.entity.FriendTopBannerBean
...
class FriendFragment : BaseFragment<HomeFragmentFriendLayoutBinding, FriendVM>() {
    ...
    private fun initViewPagerAndTabs() {
        ...
        mBinding.friendviewPager.apply {
            adapter = CommonViewPagerAdapter(this@FriendFragment.requireActivity(), fragmentList)
    ...
    private fun initMagicIndicator(count: Int) {
        val commonNavigator = com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.CommonNavigator(
            context
        ).apply {
            scrollPivotX = 0.8f
            adapter = object : com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.abs.CommonNavigatorAdapter() {
                override fun getCount() = count

                override fun getTitleView(context: Context?, index: Int): com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.abs.IPagerTitleView {
                    return com.mm.shanai.common.view.magicindicator.ScaleTransitionPagerBoldTitleView(
                        context
                    ).apply {
                ...
                override fun getIndicator(context: Context?): com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.abs.IPagerIndicator {
                    return com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.indicators.LinePagerIndicator(
                        context
                    ).apply {
                        mode = com.mm.shanai.common.view.magicindicator.buildins.commonnavigator.indicators.LinePagerIndicator.MODE_EXACTLY
                        lineHeight = com.mm.shanai.common.view.magicindicator.buildins.UIUtil.dip2px(context, 4.0).toFloat()
                        lineWidth = com.mm.shanai.common.view.magicindicator.buildins.UIUtil.dip2px(context, 12.0).toFloat()
                        roundRadius = com.mm.shanai.common.view.magicindicator.buildins.UIUtil.dip2px(context, 2.0).toFloat()
        ...
        com.mm.shanai.common.view.magicindicator.ViewPagerHelper.bind(mBinding.friendMagicIndicator, mBinding.friendviewPager)
    }
